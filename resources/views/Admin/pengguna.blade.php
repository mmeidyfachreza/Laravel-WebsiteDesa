...
<div class="">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <a href="{{url('register')}}" class="btn btn-default"><span class="fa fa-plus"></span>  Tambah</a>
        ...
        <div class="x_content">
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td>{{ $x++ }}</td>
                <td>{{ $dataa->name or 'data kosong' }}</td>
                <td>{{ $dataa->email or 'data kosong' }}</td>
                <td>{{ $dataa->roles->first()->nama or 'data kosong' }}</td>
                <td>
