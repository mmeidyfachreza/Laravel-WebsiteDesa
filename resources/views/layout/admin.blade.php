        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a href="{{url('/admin')}}"><i class="fa fa-home"></i> Beranda</a>
                  ...
                  <li><a href="{{url('/pengguna')}}"><i class="fa fa-comment"></i>Pengguna</a>
                  </li>
                  <li><a href="{{url('/jenis_pengguna')}}"><i class="fa fa-comment"></i> Jenis Pengguna</a>
                  </li>
                  <li><a href="{{url('/b_galeri')}}"><i class="fa fa-comment"></i>Galeri</a>
                  </li>
                </ul>
              </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li role="presentation" class="dropdown">
                ...
                <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                  <li>
                    <a>
                      <span class="image"><img src="{{asset('img/meidy.jpg')}}" alt="Profile Image" /></span>
                      <span>
